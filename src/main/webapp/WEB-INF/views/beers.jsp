...
<html lang="en">
	<head>
        <meta charset="utf-8">
        <title>Black Lion CRM - Add Beers</title>
...
<div class="layout layout-nav-side">
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                <a class="navbar-brand" href="beers">
									...
									<div class="tab-pane fade show active" role="tabpanel"
										...
										<div class="media mb-4">
											...
											<div class="media-body ml-3">
												<h1>Beer Inventory List</h1>
											</div>
										</div>
										<!--end of avatar-->
										<form:form method="POST" modelAttribute="order" action="/order">
											<div class="form-group row align-items-center">
												<label class="col-3">Account Name</label> <!-- drop down list of accounts -->
												<div class="col">
													<input type="text" placeholder="Account Name" value="Account Name"
														name="profile-beer-name" class="form-control" required />
												</div>
											</div>
											<div class="form-group row align-items-center">
												<label class="col-3">Select Beer</label> <!-- drop down list of accounts -->
												<div class="col">
													<input type="text" placeholder="Beer List" value="Select Beer"
														name="profile-beer-name" class="form-control" required />
												</div>
											</div>
