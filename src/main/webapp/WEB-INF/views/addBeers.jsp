...
<div class="layout layout-nav-side">
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                <a class="navbar-brand" href="addBeers.html">
									...
									<div class="tab-pane fade show active" role="tabpanel"
										...
										<form:form method="POST" modelAttribute="order" action="/order">
											<div class="form-group row align-items-center">
												...
												<div class="col">
													<input type="text" placeholder="Account Name" value="Select Account"
														name="profile-beer-name" class="form-control" required />
												</div>
											</div>
											<div class="form-group row align-items-center">
												<label class="col-3">Add Beer(s) To Order</label> <!-- drop down list of accounts -->
												<div class="col">
													<input type="text" placeholder=""
														value="Select Beer" name="Select Beer From List"
														class="form-control" />
												</div>
											</div>
